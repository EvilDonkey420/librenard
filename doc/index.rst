...
For a deeper understanding of the inner workings of ``librenard``, please refer to |renard-spec|_.
...
.. |renard-spec| replace:: ``renard-spec``
.. _renard-spec: https://github.com/Jeija/renard-spec
